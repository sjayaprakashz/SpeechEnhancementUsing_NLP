...
# Set up the MinDalle model
model = MinDalle(is_mega=True, is_reusable=True)

# Streamlit app title and input
st.title("Text-to-Image Generation with MinDalle")
text = st.text_input("Enter a text prompt:", "narendra modi on moon")

# Streamlit widgets for options (you can customize these if needed)
seed = 6
grid_size = 2
...
if st.button("Generate Image"):
    # Generate the image
    generated_image = model.generate_image(text, seed, grid_size)
